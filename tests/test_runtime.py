...
CLIENT_LIST\t0004_Router1\t203.0.113.7:45678\t10.8.4.1\t\t100\t200\t2026-09-16 10:00:00\t1789552800\tUNDEF\t0\t0\tAES-256-GCM
END
"""
...
def test_status_version_three_exposes_connection_details() -> None:
    ...
    connection = connections["0004_router1"]
...
0004_Router1,203.0.113.7:45678,100,200,Wed Sep 16 10:00:00 2026
ROUTING TABLE
Virtual Address,Common Name,Real Address,Last Ref
10.8.4.1,0004_Router1,203.0.113.7:45678,Wed Sep 16 10:00:04 2026
GLOBAL STATS
Max bcast/mcast queue length,0
END
"""
    assert list(parse_status_text(content)) == ["0004_router1"]
...
def test_status_snapshot_detects_stale_file(tmp_path: Path) -> None:
    ...
    assert "0004_router1" in snapshot.connections
