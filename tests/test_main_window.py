...
def test_oven_settings_and_complete_list_export(tmp_path, monkeypatch, language):
    ...
    try:
        ...
        assert branch.text(0) == "(2) 0004 - Test branch"
        assert window.tree.topLevelItem(1).text(0) == "(0) 0005 - Empty branch"
